...
///
/// The noise module classes that are included in UnrealLibNoise can be roughly
...
/// - Perlin: Outputs a value generated by a Perlin-noise
///   function.
/// - Outputs a value generated by a Voronoi-cell
///   function.
///
...
/// - Curve: Maps the output value from the source module
///   onto an arbitrary function curve.
/// - Invert: Inverts the output value from the source
///   module.
///
...
/// - Add: Adds the two output values from two source
///   modules.
/// - Max: Outputs the larger of the two output values from
///   two source modules.
///
...
/// - Blend: Outputs a value that is linearly interpolated
...
/// - Select: Outputs the value selected from one of two
...
/// Add module requires two source modules, while the
/// Perlin module requires none.  Call the
...
/// For example, consider the Select noise module, which
...
public:
	...
	///
	/// @throw Exception See the preconditions for more
	/// information.
	///
	/// Each noise module requires the attachment of a certain number of
	...
	/// @param InModule The source module to attach.
	///
	/// @pre The index value ranges from 0 to one less than the number of
	/// source modules required by this noise module.
	///
	...
	virtual void SetSourceModule(int32 index, UNoiseModule* InModule)
	{
...
private:
	...
	/// this noise module.
	TArray<UNoiseModule*> SourceMoudules;
};
